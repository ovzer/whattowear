...
C238.537,586.687,273.509,577.708,299.017,580.318z"
      ...
      <ellipse
        fill={theme.palette.common.white}
        transform="matrix(0.9848 0.1736 -0.1736 0.9848 101.4322 -44.3708)"
        cx="304.294"
        cy="557.497"
        rx="12.833"
        ry="17.833"
      ...
      <path
        ...
        d="M229,612.501c-0.667,3.5-5.333,7.667-6.333,12s3.163,11.167,5.915,6.5s2.919-8.333,4.752-10.5
s3.654-3.363,2.5-4S229.53,609.718,229,612.501z"
      />
      <path
        fill={theme.palette.secondary.main}
        d="M356.333,580.167c1.667-0.5,3.834-2.666,4.334-5.666s1.763-3.501,1.763,3.166s-0.931,7.167-1.097,9.167
S354.666,580.667,356.333,580.167z"
      />
      // Lue
      <path
        fill={theme.palette.secondary.main}
        visibility={currentClothes.head.lue.shouldWear ? 'visible' : 'hidden'}
        d="M318.528,555.144c-0.372-8.179-4.645-14.824-10.884-15.925
c-6.802-1.198-13.65,4.595-16.435,13.347C303.879,554.485,312.582,555.116,318.528,555.144z"
      ...
      <path
        fill={theme.palette.secondary.main}
        visibility={
          currentClothes.head.panneband.shouldWear ? 'visible' : 'hidden'
        }
        d="M296.612,543.174c-2.318,2.338-4.226,5.497-5.402,9.195
c12.669,1.921,21.373,2.552,27.319,2.578c-0.163-3.565-1.067-6.839-2.551-9.488C311.687,545.225,305.87,544.675,296.612,543.174z"
      ...
      <path
        fill={theme.palette.secondary.main}
        d="M299.017,580.318c-20.995-2.148-48.391,3.573-65.257,29.344
...
c-1.108-1.912-1.771-2.402-4.847-7.569C337.107,589.34,317.605,582.221,299.017,580.318z"
      ...
      <path
        fill={theme.palette.secondary.main}
        visibility={
          currentClothes.lowerBody.tights.shouldWear ? 'visible' : 'hidden'
        }
        d="M237.724,703.048c14.387-9.145,28.744-21.619,41.026-39.952
...
C231.275,701.277,234.196,702.313,237.724,703.048z"
      ...
      <path
        fill={theme.palette.secondary.main}
        d="M289.132,577.5c-12.465,0.167-26.965,4.666-32.632,7s-10,6.333-13,10s-8.598,8.933-11.167,13.882
...
s-1.092,1.104-6.092,3.104s-12.334,1.667-18.334,0S315.5,581.166,311.5,580.5S301.598,577.333,289.132,577.5z"
      ...
      <path
        fill={theme.palette.secondary.main}
        visibility={
          currentClothes.lowerBody.overtrekksbukse.shouldWear
            ? 'visible'
            : 'hidden'
        }
        d="M261.526,644.555c-1.071,2.666-6.026,14.279-9.36,20.779c-1.725,3.362-8.719,9.568-11.333,15.667
...
s-10.942-3.001-15.721-3.334s-22.636-2.033-25.802-2.533S262.597,641.889,261.526,644.555z"
      ...
      <path
        fill={theme.palette.secondary.main}
        visibility={currentClothes.head.buff.shouldWear ? 'visible' : 'hidden'}
        d="M291.279,571.501c-0.241,2.022-0.279,4.166-1.279,5.666s-2.942,3.333,1.279,3.5s11.888,0.667,14.888,1.667
